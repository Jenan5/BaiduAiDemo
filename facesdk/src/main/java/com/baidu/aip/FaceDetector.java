...
import static com.baidu.aip.FaceEnvironment.VALUE_MAX_CROP_IMAGE_NUM;
...
//    public static final float DEFAULT_NOT_FACE_THRESHOLD = 0.8f;
    public static final float DEFAULT_NOT_FACE_THRESHOLD = 0.6f;

    /**
     * 默认最小人脸，小于此值的人脸将检测不出来
     */
//    public static final int DEFAULT_MIN_FACE_SIZE = 120;
    public static final int DEFAULT_MIN_FACE_SIZE = 60;
    ...
    public static final int DEFAULT_HEAD_ANGLE = 60;
    ...
    private FaceDetector(Context context, String appId, String licenseFileName) {
        ...
        mFaceTracker.set_max_reg_img_num(MAX_REG_IMG_NUM);
        ...
        // mFaceTracker.set_detection_frame_interval(100);
        // 人脸检测到后追踪的时间间隔
