...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "zjFD2qxViui0DduObBm15veu";
    public static String secretKey = "kuMHLiYZesuBCiZIPIOyPp8Nz3tA7hgr";
    public static String licenseID = "facedetactofsteam-face-android";
